...
@section('content')
                            ...
                            <tr class="hover:bg-slate-700/30 transition-all duration-200 group" data-schedule-id="{{ $schedule['id'] }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        @if(in_array($schedule['status'], ['Pending Approval', 'Confirmed']))
                                        ...
                                        @else
                                            <button disabled
                                                    ...
                                                    title="Cannot edit - schedule is {{ $schedule['status'] }}">
                                                <i class="fas fa-edit text-xs"></i>
                                                Edit
                                            </button>
                                        @endif
                                        ...
                                        @else
                                            <button disabled
                                                    class="inline-flex items-center px-3 py-1.5 bg-slate-800/30 border border-slate-700/30 rounded-lg text-slate-500 cursor-not-allowed opacity-50 text-xs font-medium flex items-center gap-1.5"
                                                    title="Cannot cancel - schedule is {{ $schedule['status'] }}">
                                                <i class="fas fa-times text-xs"></i>
                                                Cancel
                                            </button>
                                        @endif
    ...
    <script>
        ...
        window.scheduleDeleteRoute = '{{ route("customer.cancel", ":schedule") }}';
    </script>
