...
<head>
    ...
    <meta property="og:image" content="{{ asset('images/logo-removebg-preview_imgupscaler.ai_General_16K.png') }}">
    ...
    <meta name="twitter:image" content="{{ asset('images/logo-removebg-preview_imgupscaler.ai_General_16K.png') }}">
    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                <div class="logo">
                    <img src="{{ asset('images/logo-removebg-preview_imgupscaler.ai_General_16K.png') }}" alt="Latino Laundry" class="logo-image">
                </div>
                ...
                <div class="header-actions">
                    ...
                    <a href="{{ route('login') }}" class="btn btn--primary btn--sm">Schedule Now</a>
                </div>
    ...
    <div class="mobile-menu hidden">
        <div class="mobile-menu-content">
            ...
            <div class="mobile-menu-actions">
                ...
                <a href="{{ route('login') }}" class="btn btn--primary btn--full-width">Schedule Now</a>
            </div>
        </div>
    </div>
            ...
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <div class="hero-buttons">
                        <a href="{{ route('login') }}" class="btn btn--primary btn--lg">Schedule Now</a>
                ...
                <div class="hero-image">
                    <div class="hero-image-container">
                        <img src="{{ asset('images/1.jpg') }}" alt="Professional Laundry Service" class="hero-image-main" id="heroImage1">
                        <img src="{{ asset('images/2.jpg') }}" alt="Professional Laundry Service" class="hero-image-main" id="heroImage2" style="display: none;">
                    </div>
                </div>
            </div>
        </div>
