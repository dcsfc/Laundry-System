...
<?php $__env->startSection('content'); ?>
                            ...
                            <tr class="hover:bg-slate-700/30 transition-all duration-200 group" data-schedule-id="<?php echo e($schedule['id']); ?>">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <?php if(in_array($schedule['status'], ['Pending Approval', 'Confirmed'])): ?>
                                        ...
                                        <?php else: ?>
                                            <button disabled
                                                    ...
                                                    title="Cannot edit - schedule is <?php echo e($schedule['status']); ?>">
                                                <i class="fas fa-edit text-xs"></i>
                                                Edit
                                            </button>
                                        <?php endif; ?>
                                        ...
                                        <?php else: ?>
                                            <button disabled
                                                    class="inline-flex items-center px-3 py-1.5 bg-slate-800/30 border border-slate-700/30 rounded-lg text-slate-500 cursor-not-allowed opacity-50 text-xs font-medium flex items-center gap-1.5"
                                                    title="Cannot cancel - schedule is <?php echo e($schedule['status']); ?>">
                                                <i class="fas fa-times text-xs"></i>
                                                Cancel
                                            </button>
                                        <?php endif; ?>
    ...
    <!-- Include CSS -->
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/customer-schedules.css']); ?>

    <!-- Include JavaScript -->
    <script>
        // Set the routes for form submission
        window.scheduleStoreRoute = '<?php echo e(route("customer.schedules.store")); ?>';
        window.scheduleUpdateRoute = '<?php echo e(route("customer.schedules.update", ":schedule")); ?>';
        window.scheduleDeleteRoute = '<?php echo e(route("customer.cancel", ":schedule")); ?>';
    </script>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/modules/schedules/customer-schedules.js']); ?>
