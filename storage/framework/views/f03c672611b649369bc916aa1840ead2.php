                ...
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $upcomingSchedules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $schedule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex items-start gap-3 p-3 bg-slate-700/30 rounded-lg hover:bg-slate-700/50 transition-colors">
                            <div class="w-8 h-8 <?php echo e($statusColor['bg']); ?> rounded-full flex items-center justify-center">
                                <i class="<?php echo e($statusColor['icon']); ?> text-sm"></i>
                            </div>
                            <div class="flex-1">
                                <h4 class="text-slate-50 font-medium"><?php echo e($schedule['service_type']); ?> - <?php echo e($schedule['status']); ?></h4>
                                <p class="text-slate-400 text-sm">Drop-off: <?php echo e($schedule['dropoff_date']); ?> at <?php echo e($schedule['dropoff_time']); ?></p>
                                <p class="text-slate-500 text-xs mt-1">Pickup: <?php echo e($schedule['pickup_date']); ?> at <?php echo e($schedule['pickup_time']); ?></p>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <div class="text-center py-8">
