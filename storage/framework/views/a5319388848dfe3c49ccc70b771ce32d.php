        ...
        <div class="mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('customer.schedules.index')); ?>" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <div class="text-2xl font-bold text-slate-50">Schedule #<?php echo e($schedule['id']); ?></div>
                            <div class="text-slate-400">Created on <?php echo e($schedule['created_at']); ?></div>
                        </div>
                        <?php
                            $statusColors = [
                        ...
                        ?>
                        <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium border <?php echo e($statusColor); ?>">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-xs text-slate-400"><?php echo e($schedule['created_at']); ?></div>
                            </div>
                        </div>
                        
                        <?php if($schedule['status'] === 'Confirmed' || $schedule['status'] === 'Pending'): ?>
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-emerald-500 rounded-full flex items-center justify-center">
                                    <i class="fas fa-check text-white text-sm"></i>
                                </div>
                ...
                <div class="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center py-2 border-b border-slate-700">
                            ...
                            <span class="text-slate-200 font-medium"><?php echo e($schedule['service_type']); ?></span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-slate-700">
                            <span class="text-slate-400">Staff Assigned</span>
                            <span class="text-slate-200 font-medium"><?php echo e($schedule['staff_assigned']); ?></span>
                        </div>
                        <?php if(isset($schedule['estimated_completion'])): ?>
                            <div class="flex justify-between items-center py-2 border-b border-slate-700">
                                <span class="text-slate-400">Estimated Completion</span>
                                <span class="text-slate-200 font-medium"><?php echo e($schedule['estimated_completion']); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if(isset($schedule['special_instructions']) && $schedule['special_instructions']): ?>
                            <div class="py-2">
                                <span class="text-slate-400 block mb-2">Special Instructions</span>
                                <span class="text-slate-200"><?php echo e($schedule['special_instructions']); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if($schedule['notes']): ?>
                            <div class="py-2">
                                <span class="text-slate-400 block mb-2">Notes</span>
                                <span class="text-slate-200"><?php echo e($schedule['notes']); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="space-y-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-slate-200 font-medium"><?php echo e($schedule['dropoff_date']); ?></div>
                                <div class="text-slate-300 text-sm"><?php echo e($schedule['dropoff_time']); ?></div>
                            </div>
                        </div>
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="text-slate-200 font-medium"><?php echo e($schedule['pickup_date']); ?></div>
                                <div class="text-slate-300 text-sm"><?php echo e($schedule['pickup_time']); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="text-slate-300"><?php echo e($schedule['customer_name']); ?></span>
                        </div>
                        <div class="flex items-center gap-3">
                            <i class="fas fa-phone text-emerald-400"></i>
                            <span class="text-slate-300"><?php echo e($schedule['customer_phone']); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-slate-800 border border-slate-700 rounded-xl p-6">
                    ...
                    <div class="space-y-3">
                        <?php if($schedule['status'] === 'Scheduled' || $schedule['status'] === 'Pending'): ?>
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laundry Sytem\Thesis\resources\views/customer/schedules/show.blade.php ENDPATH**/ ?>