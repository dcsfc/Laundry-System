    ...
    <div class="container">
            ...
            <div class="group bg-gradient-to-tr from-slate-800 to-slate-700 border border-slate-700 rounded-xl p-6 hover:shadow-lg hover:border-sky-400/40 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-slate-50 text-2xl font-bold"><?php echo e($totalUsers ?? 1247); ?></p>
            ...
            <div class="group bg-gradient-to-tr from-slate-800 to-slate-700 border border-slate-700 rounded-xl p-6 hover:shadow-lg hover:border-cyan-400/40 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-slate-50 text-2xl font-bold">₱<?php echo e(number_format($totalRevenue ?? 12500)); ?></p>
            ...
            <div class="group bg-gradient-to-tr from-slate-800 to-slate-700 border border-slate-700 rounded-xl p-6 hover:shadow-lg hover:border-sky-400/40 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-slate-50 text-2xl font-bold"><?php echo e($completedLaundry ?? 320); ?></p>
                        <p class="text-sky-400 text-sm font-medium mt-1 flex items-center">
            ...
            <div class="group bg-gradient-to-tr from-slate-800 to-slate-700 border border-slate-700 rounded-xl p-6 hover:shadow-lg hover:border-cyan-400/40 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div>
                        ...
                        <p class="text-slate-50 text-2xl font-bold"><?php echo e($pendingLaundry ?? 45); ?></p>
                        <p class="text-cyan-400 text-sm font-medium mt-1 flex items-center">
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 hover:shadow-lg transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <a href="<?php echo e(route('admin.users.create')); ?>" class="group flex items-center gap-3 p-4 bg-slate-700/50 border border-slate-600 rounded-lg hover:bg-sky-500 hover:border-sky-400 transition-all duration-300 hover:scale-105">
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>" class="group flex items-center gap-3 p-4 bg-slate-700/50 border border-slate-600 rounded-lg hover:bg-indigo-500 hover:border-indigo-400 transition-all duration-300 hover:scale-105">
...
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laundry Sytem\Thesis\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>