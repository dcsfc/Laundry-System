    ...
    <div class="login-container">
        <div class="login-card">
            ...
            <div class="signup-link">
                <p>Don't have an account? <a href="<?php echo e(route('register')); ?>" class="signup-text">Sign up here</a></p>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\Laundry Sytem\Thesis\resources\views/auth/customer-login.blade.php ENDPATH**/ ?>