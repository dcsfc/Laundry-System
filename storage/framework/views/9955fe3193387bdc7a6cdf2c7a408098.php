  ...
  <div class="sidebar fixed top-14 left-0 w-60 h-[calc(100vh-3.5rem)] bg-slate-900 border-r border-<?php echo e($accentColor); ?>-500/20 z-[100] flex flex-col shadow-2xl transition-all duration-300 ease-in-out" id="sidebar">
    ...
    <div class="sidebar-nav flex-1 overflow-y-auto py-6 px-3 scrollbar-thin scrollbar-track-slate-800 scrollbar-thumb-slate-600">
      ...
      <?php if($isAdmin || $isStaff): ?>
        <a href="<?php echo e($isAdmin ? route('admin.orders.index') : route('staff.orders.index')); ?>" class="group flex items-center gap-3 px-4 py-3 mb-1 text-slate-300 hover:text-white text-sm font-medium rounded-xl transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:<?php echo e($gradientHoverFrom); ?> hover:<?php echo e($gradientHoverTo); ?> hover:shadow-lg hover:shadow-<?php echo e($shadowColor); ?>-500/10 hover:translate-x-1 <?php echo e(request()->routeIs(($isAdmin ? 'admin' : 'staff') . '.orders.*') ? 'bg-gradient-to-r ' . $gradientFrom . ' ' . $gradientTo . ' text-white shadow-lg shadow-' . $shadowColor . '-500/25 font-semibold' : ''); ?>">
          <i class="sidebar-icon fas fa-shopping-cart w-5 text-center text-base group-hover:scale-110 transition-transform duration-300 flex-shrink-0 <?php echo e(request()->routeIs(($isAdmin ? 'admin' : 'staff') . '.orders.*') ? 'text-white' : 'text-slate-400'); ?>"></i>
      ...
      <?php elseif($isCustomer): ?>
        <a href="<?php echo e(route('customer.schedules.index')); ?>" class="group flex items-center gap-3 px-4 py-3 mb-1 text-slate-300 hover:text-white text-sm font-medium rounded-xl transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:<?php echo e($gradientHoverFrom); ?> hover:<?php echo e($gradientHoverTo); ?> hover:shadow-lg hover:shadow-<?php echo e($shadowColor); ?>-500/10 hover:translate-x-1 <?php echo e(request()->routeIs('customer.schedules.*') ? 'bg-gradient-to-r ' . $gradientFrom . ' ' . $gradientTo . ' text-white shadow-lg shadow-' . $shadowColor . '-500/25 font-semibold' : ''); ?>">
          <i class="sidebar-icon fas fa-calendar-alt w-5 text-center text-base group-hover:scale-110 transition-transform duration-300 flex-shrink-0 <?php echo e(request()->routeIs('customer.schedules.*') ? 'text-white' : 'text-slate-400'); ?>"></i>
      ...
      <?php if($isCustomer): ?>
        <a href="<?php echo e(route('customer.orders.index')); ?>" class="group flex items-center gap-3 px-4 py-3 mb-1 text-slate-300 hover:text-white text-sm font-medium rounded-xl transition-all duration-300 ease-in-out hover:bg-gradient-to-r hover:<?php echo e($gradientHoverFrom); ?> hover:<?php echo e($gradientHoverTo); ?> hover:shadow-lg hover:shadow-<?php echo e($shadowColor); ?>-500/10 hover:translate-x-1 <?php echo e(request()->routeIs('customer.orders.*') ? 'bg-gradient-to-r ' . $gradientFrom . ' ' . $gradientTo . ' text-white shadow-lg shadow-' . $shadowColor . '-500/25 font-semibold' : ''); ?>">
          <i class="sidebar-icon fas fa-history w-5 text-center text-base group-hover:scale-110 transition-transform duration-300 flex-shrink-0 <?php echo e(request()->routeIs('customer.orders.*') ? 'text-white' : 'text-slate-400'); ?>"></i>
